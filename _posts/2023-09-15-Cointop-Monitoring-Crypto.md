---
layout: post
slug: Cointop Monitoring Aset Kripto
---


sangat si paling monitoring, asetmu sudah jadi abu
...
```
git clone https://github.com/cointop-sh/cointop
```

pake AUR

```
https://aur.archlinux.org/cointop.git
```

saya pake dari AUR, build
...
Flags:
      ...
      --colorscheme string             Colorscheme to use (default "cointop").
                                       ...
                                       git clone git@github.com:cointop-sh/colors.git /home/tama/.config/cointop/colors
                                       
                                       See git.io/cointop#colorschemes for more info.
  -c, --config string                  Config filepath. (default /home/tama/.config/cointop/config.toml)
...
<img src="https://raw.githubusercontent.com/oksaamerta/oksaamerta.github.io/master/_screenshots/cointop.png" />
